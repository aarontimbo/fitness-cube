            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="recipe.instructions.label" default="Instructions" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="recipe.servingMultiplier.label" default="Serving Multiplier" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: recipeInstance, field: "servingMultiplier")}</td>
